...
type TradePlateItemResp struct {
	Price  float64 `json:"price"`
	Amount float64 `json:"amount"`
}

type TradePlateResultResp struct {
	...
	Symbol       string                `json:"symbol"`
	Items        []*TradePlateItemResp `json:"items"`
}

type TradePlateResp struct {
	Ask *TradePlateResultResp `json:"ask"`
	Bid *TradePlateResultResp `json:"bid"`
}
