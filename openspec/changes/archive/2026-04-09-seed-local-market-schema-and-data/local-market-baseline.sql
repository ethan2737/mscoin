...
VALUES
  ('Bitcoin',1,1,1,'比特币',1,1,'BTC',68000,8,'https://bitcoin.org','Local baseline coin metadata for BTC'),
  ('Tether',1,1,1,'泰达币',2,1,'USDT',1,6,'https://tether.to','Local baseline coin metadata for USDT'),
  ('Ethereum',1,1,1,'以太坊',3,1,'ETH',3200,8,'https://ethereum.org','Local baseline coin metadata for ETH'),
  ('Solana',1,1,1,'索拉纳',4,1,'SOL',180,8,'https://solana.com','Local baseline coin metadata for SOL')
